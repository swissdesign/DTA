document.addEventListener('DOMContentLoaded', () => {
  ...
  const modalCloseButtons = [modalClose, modalSecondary];

  const modalReady = [
    modal, modalTitle, modalDescription, modalPrice, modalSponsor, modalStatus, modalCta, modalSecondary, modalClose
  ].every(Boolean);
